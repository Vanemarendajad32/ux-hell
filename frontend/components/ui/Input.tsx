...
export default function Input({ label, error, className, ...props }: InputProps) {
  ...
  return (
    <div className="flex flex-col mb-4">
      <label className="block text-sm font-semibold mb-2.5 text-slate-700" htmlFor={props.name}>
        {label}
      </label>
      <input id={props.name} {...props} className={cn(inputClassName, errorClassName, className)} />
