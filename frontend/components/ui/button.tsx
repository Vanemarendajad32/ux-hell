...
const buttonBase =
  "group/button inline-flex shrink-0 items-center justify-center border border-transparent bg-clip-padding text-sm font-semibold whitespace-nowrap cursor-pointer transition-all outline-none select-none focus-visible:ring-4 focus-visible:ring-rose-100 focus-visible:border-rose-500 disabled:pointer-events-none disabled:opacity-50 active:translate-y-px [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4";
